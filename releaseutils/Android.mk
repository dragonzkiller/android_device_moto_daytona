...
include $(CLEAR_VARS)
LOCAL_MODULE := daytona_releaseutils-check_kernel
...
include $(CLEAR_VARS)
LOCAL_MODULE := daytona_releaseutils-finalize_release
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_CLASS := ETC
LOCAL_MODULE_PATH := $(TARGET_OUT_ETC)/releaseutils
...
include $(CLEAR_VARS)
LOCAL_MODULE := daytona_releaseutils-mke2fs
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_CLASS := ETC
LOCAL_MODULE_PATH := $(TARGET_OUT_ETC)/releaseutils
...
include $(CLEAR_VARS)
LOCAL_MODULE := daytona_releaseutils-tune2fs
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_CLASS := ETC
LOCAL_MODULE_PATH := $(TARGET_OUT_ETC)/releaseutils
